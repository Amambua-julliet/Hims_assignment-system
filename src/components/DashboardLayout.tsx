      ...
      <aside className="w-72 bg-white border-r border-slate-200 flex flex-col z-30">
        <div className="p-6">
          <Link to="/dashboard" className="flex items-center gap-3">
            ...
            <span className="text-xl font-bold tracking-tight text-hims-blue">ACADSUBMIT</span>
          </Link>
        </div>
        ...
        <div className="p-4 border-t border-slate-100">
          <div className="bg-slate-50 rounded-2xl p-4 flex items-center gap-3">
            ...
            <div className="flex-1 overflow-hidden">
              ...
              <p className="text-[10px] font-semibold text-hims-slate scroll-m-20">System Admin</p>
            </div>
            <button className="text-hims-slate hover:text-red-500 transition-colors">
              <LogOut size={18} />
            </button>
          </div>
        </div>
      ...
      <main className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        <header className="h-20 bg-white border-b border-slate-200 flex items-center justify-between px-8 z-20">
          <div className="flex items-center gap-4 flex-1">
            <h1 className="text-xl font-bold text-hims-dark">
              {menuItems.find(item => item.path === location.pathname)?.label || 'Dashboard'}
            </h1>
            <div className="hidden md:flex items-center gap-2 text-hims-slate text-sm">
              <ChevronRight size={14} />
              <span>HIMS Buea system</span>
            </div>
          </div>
